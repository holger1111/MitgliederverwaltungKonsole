...
--
-- Host: mein-mysql
-- Erstellungszeit: 06. Nov 2025 um 10:37
...
INSERT INTO `Artikel` (`ArtikelID`, `Name`, `Einzelpreis`, `Kommentar`) VALUES
(1, 'Handtuch L', 9.99, NULL),
(2, 'Handtuch XL', 14.99, NULL),
(3, 'Bio-Protein-Shake', 4.50, 'Special-Harvest'),
(4, 'Protein-Shake', 3.50, 'Plastique Nutrition'),
(5, 'Kaffee schwarz', 4.50, NULL),
(6, 'Kaffee Milch', 5.00, NULL),
(7, 'Kaffee Hafermilch', 5.50, NULL);
...
--
ALTER TABLE `Artikel`
  MODIFY `ArtikelID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT für Tabelle `Bestellung`
--
ALTER TABLE `Bestellung`
  MODIFY `BestellungID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `Mitglieder`
  MODIFY `MitgliederID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT für Tabelle `MitgliederVertrag`
--
ALTER TABLE `MitgliederVertrag`
  MODIFY `VertragNr` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT für Tabelle `Ort`
--
ALTER TABLE `Ort`
  MODIFY `OrtID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `Zahlung`
  MODIFY `ZahlungID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT für Tabelle `Zahlungsdaten`
--
ALTER TABLE `Zahlungsdaten`
  MODIFY `ZahlungsdatenID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
