...
--
-- Host: mein-mysql
-- Erstellungszeit: 29. Okt 2025 um 09:34
...
--
ALTER TABLE `Mitglieder`
  MODIFY `MitgliederID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT für Tabelle `MitgliederVertrag`
--
ALTER TABLE `MitgliederVertrag`
  MODIFY `VertragNr` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT für Tabelle `Ort`
--
ALTER TABLE `Ort`
  MODIFY `OrtID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `Zahlung`
  MODIFY `ZahlungID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT für Tabelle `Zahlungsdaten`
--
ALTER TABLE `Zahlungsdaten`
  MODIFY `ZahlungsdatenID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
