...
public class TelefonValidator extends StringValidator {

    // Land -> {minLänge, maxLänge}
    private static final Map<String, int[]> COUNTRY_CODES = Map.ofEntries(
        Map.entry("+49", new int[]{11, 13}), // Deutschland
    ...
    private static final Map<String, String> COUNTRY_INTL_FORMATS = Map.ofEntries(
        Map.entry("+49", "+49 170 1234567"),
        Map.entry("+43", "+43 660 1234567"),
        Map.entry("+41", "+41 79 123 45 67"),
        Map.entry("+33", "+33 1 23 45 67 89"),
        Map.entry("+32", "+32 12 34 56 78"),
        Map.entry("+31", "+31 6 12345678"),
        Map.entry("+352", "+352 26 123456"),
        Map.entry("+39", "+39 347 1234567"),
        Map.entry("+34", "+34 612 34 56 78"),
        Map.entry("+351", "+351 912 345 678"),
        Map.entry("+45", "+45 12 34 56 78"),
        Map.entry("+46", "+46 70 123 45 67"),
        Map.entry("+47", "+47 123 45 678"),
        Map.entry("+358", "+358 40 1234567"),
        Map.entry("+48", "+48 123 456 789"),
        Map.entry("+420", "+420 123 456 789"),
        Map.entry("+36", "+36 30 123 4567"),
        Map.entry("+30", "+30 210 1234567"),
        Map.entry("+421", "+421 901 234 567"),
        Map.entry("+40", "+40 721 234 567"),
        Map.entry("+359", "+359 88 123 4567"),
        Map.entry("+385", "+385 91 234 5678"),
        Map.entry("+381", "+381 64 1234567"),
        Map.entry("+386", "+386 40 123 456"),
        Map.entry("+387", "+387 61 123 456"),
        Map.entry("+389", "+389 70 123 456"),
        Map.entry("+382", "+382 67 123 456"),
        Map.entry("+355", "+355 69 123 4567"),
        Map.entry("+372", "+372 5123 4567"),
        Map.entry("+371", "+371 22 123 456"),
        Map.entry("+370", "+370 612 34567"),
        Map.entry("+353", "+353 85 123 4567"),
        Map.entry("+44", "+44 7700 900123"),
        Map.entry("+354", "+354 660 1234"),
        Map.entry("+423", "+423 123 4567")
    );
     ...
     * @param example Beispielnummer mit Leerzeichen, z.B. "+49 170 1234567"
     * @return formatierte Telefonnummer, z.B. "+49 170 1234567"
     */
    private String formatTelefonnummer(String rawNumber, String example) {
        ...
        for (int i = 0; i < example.length(); i++) {
            ...
            if (c == ' ') {
                ...
                if (rawIndex < rawNumber.length()) {
                    formatted.append(rawNumber.charAt(rawIndex));
                    rawIndex++;
                } else {
                    break;
                }
        ...
        // Falls noch unformatierte Zeichen übrig sind, hinzufügen
        if (rawIndex < rawNumber.length()) {
            formatted.append(rawNumber.substring(rawIndex));
        }
